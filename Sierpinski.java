...
// The following code draws Sierpinskis fractal triangles
...
public class Sierpinski extends JFrame 
{
	...
	{
		if (p1.distance(p2) < THRESHOLD && p1.distance(p3) < THRESHOLD && p2.distance(p3) < THRESHOLD) return;
